...
void padder(unsigned char* pad_in, unsigned char* pad_out) {
    size_t i = 0;
...
unsigned char** splitter(unsigned char* split_in, int* num_chunks) {
...
int sub_bytes(const unsigned char* in, size_t len, unsigned char* out) {
